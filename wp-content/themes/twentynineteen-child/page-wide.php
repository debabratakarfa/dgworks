                    ...
                    <main id="main" class="content-wrapper">
                        ...
                        <form id="formToCPT" class="form form-to-cpt">
                            ...
                            <div class="form__content">
                                ...
                                <input type="date" aria-label="Date of Birth" id="dob" name="dob" placeholder="Date of Birth" maxlength="255" size="8" value="">
                            </div>
                            <div class="form__footer">
                                <div>
                                    ...
                                    <div class="button">
                                        <button id="saveForm" class="submit-btn" type="submit" name="submit" value="Submit">Submit ></button>
                                    </div>
                                </div>
                                <div>
